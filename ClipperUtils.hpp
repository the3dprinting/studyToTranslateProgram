...
void Slic3rMultiPoint_to_ClipperPath(const Slic3r::MultiPoint &input, ClipperLib::Path* output);  //MultiPoint类转化为clipper的Path类
template <class T>
void Slic3rMultiPoints_to_ClipperPaths(const T &input, ClipperLib::Paths* output);  //MultiPoints类转化为clipper的Paths类
template <class T>
void ClipperPath_to_Slic3rMultiPoint(const ClipperLib::Path &input, T* output);  //clipper的Path类转换为MultiPoint类
template <class T> 
void ClipperPaths_to_Slic3rMultiPoints(const ClipperLib::Paths &input, T* output);  //clipper的Paths类转换为MultiPoints类
void ClipperPaths_to_Slic3rExPolygons(const ClipperLib::Paths &input, Slic3r::ExPolygons* output);  //clipper的Paths类转换为ExPolygons类
